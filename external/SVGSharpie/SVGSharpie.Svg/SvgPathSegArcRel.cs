namespace SVGSharpie
{
    ...
    /// </summary>
    public sealed class SvgPathSegArcRel : SvgPathSeg
    {
        /// <summary>
        ...
        public SvgPathSegArcRel(float rx, float ry, float angle, bool largeArcFlag, bool sweepFlag, float x, float y)
        {
            RadiusX = rx;
            RadiusY = ry;
            Angle = angle;
        ...
        public override SvgPathSegType PathSegType => SvgPathSegType.ArcRel;
        ...
        public override void Accept(SvgPathSegVisitor visitor) => visitor.VisitArcRel(this);

        /// <inheritdoc cref="SvgPathSeg.Accept"/>
        public override TResult Accept<TResult>(SvgPathSegVisitor<TResult> visitor) => visitor.VisitArcRel(this);

        /// <inheritdoc cref="SvgPathSeg.DeepClone"/>
        public override SvgPathSeg DeepClone()
            => new SvgPathSegArcRel(RadiusX, RadiusY, Angle, LargeArcFlag, SweepFlag, X, Y);
